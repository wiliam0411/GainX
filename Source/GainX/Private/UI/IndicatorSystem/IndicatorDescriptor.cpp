...
void UIndicatorDescriptor::SetIndicatorManagerComponent(UGainXIndicatorManagerComponent* InManager) 
{
...
{
    if (UGainXIndicatorManagerComponent* Manager = ManagerPtr.Get())
    {
